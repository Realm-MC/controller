...
public enum MessageKey {
    ...
    MAPMANAGER_RELOAD_ALL_START("mapmanager.reload.all.start"),
    MAPMANAGER_RELOAD_ALL_SUCCESS("mapmanager.reload.all.success"),
    ...
    MAPMANAGER_DOWNLOAD_URL_BUILT("mapmanager.download.url.built"),
    ...
    LABEL_BILLBOARD("label.billboard"),
    LABEL_GLOW("label.glow"),
    LABEL_LINES_VISIBLE("label.lines_visible"),
    LABEL_TEXT_LINES("label.text_lines"),
    LABEL_CLICK_ACTIONS("label.click_actions"),
    LABEL_TYPE("label.type"),
    LABEL_ANIMATION("label.animation"),
    LABEL_AMOUNT("label.amount"),
    LABEL_INTERVAL("label.interval"),
    LABEL_SPEED("label.speed"),
    LABEL_OFFSET("label.offset"),
    LABEL_DATA("label.data"),
    LABEL_LONG_DISTANCE("label.long_distance"),

    TIME_DAY_SINGULAR("time.day.singular"),
    TIME_DAY_PLURAL("time.day.plural"),
    TIME_HOUR_SINGULAR("time.hour.singular"),
    TIME_HOUR_PLURAL("time.hour.plural"),
    TIME_MINUTE_SINGULAR("time.minute.singular"),
    TIME_MINUTE_PLURAL("time.minute.plural"),
    TIME_SECOND_SINGULAR("time.second.singular"),
    TIME_SECOND_PLURAL("time.second.plural"),
    TIME_NOW("time.now"),
    ...
    AUTH_COMMAND_BLOCKED("auth.command.blocked"),
    AUTH_PROXY_COMMAND_BLOCKED("auth.proxy_command.blocked"),
    ...
    MEDAL_RARITY_COMMON("medal.rarity.common"),
    MEDAL_RARITY_UNCOMMON("medal.rarity.uncommon"),
    MEDAL_RARITY_RARE("medal.rarity.rare"),
    MEDAL_RARITY_EPIC("medal.rarity.epic"),
    MEDAL_RARITY_LEGENDARY("medal.rarity.legendary"),
    MEDAL_RARITY_EVENT("medal.rarity.event"),
    MEDAL_RARITY_SEASONAL("medal.rarity.seasonal"),
    MEDAL_RARITY_UNIQUE("medal.rarity.unique"),
    MEDAL_CATEGORY_GENERAL("medal.category.general"),
    MEDAL_CATEGORY_PVP("medal.category.pvp"),
    MEDAL_CATEGORY_EVENT("medal.category.event"),
    MEDAL_CATEGORY_VIP("medal.category.vip"),
    MEDAL_CATEGORY_SPECIAL("medal.category.special"),
    ...
    TABLIST_FOOTER_SITE("tablist.footer.site"),
    TABLIST_FOOTER_STORE("tablist.footer.store"),
    TABLIST_FOOTER_DISCORD("tablist.footer.discord"),
