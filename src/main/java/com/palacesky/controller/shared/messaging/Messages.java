...
public class Messages {
    ...
    public static void success(Object recipient, String text) { send(recipient, "<green>" + text + "</green>"); }
    public static void error(Object recipient, String text) { send(recipient, "<red>" + text + "</red>"); }
