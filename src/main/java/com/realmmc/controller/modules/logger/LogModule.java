...
public class LogModule extends AbstractCoreModule {
    ...
    protected void onEnable() throws Exception {
        ...
        if (isSpigot()) {
            Class<?> loaderClass = Class.forName("com.realmmc.controller.modules.logger.SpigotLogLoader");
            ...
            Class<?> loaderClass = Class.forName("com.realmmc.controller.modules.logger.ProxyLogLoader");
            dataFolder = (File) loaderClass.getMethod("getDataFolder").invoke(null);
            serverName = (String) loaderClass.getMethod("getServerName").invoke(null);
        }
