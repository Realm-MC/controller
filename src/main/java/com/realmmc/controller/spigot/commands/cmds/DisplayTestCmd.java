...
public class DisplayTestCmd implements CommandInterface {
    ...
    public void execute(CommandSender sender, String label, String[] args) {
        ...
        boolean glow = args.length > 0 && (args[0].equalsIgnoreCase("glow") || args[0].equalsIgnoreCase("true"));
        ...
        List<String> lines = new ArrayList<>(Arrays.asList(
                ...
                "<gray>Glow: " + (glow ? "<green>ON" : "<red>OFF"),
    ...
    public List<String> tabComplete(CommandSender sender, String[] args) {
        if (args.length == 1) {
            return Arrays.asList("clear", "glow", "true", "false");
        }
