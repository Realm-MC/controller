...
public class NpcCommand implements CommandInterface {
    ...
    private void handleCreate(CommandSender sender, String[] args) {
        ...
        String id = args[1];
        if (npcService.getNpcById(id) != null) { Messages.send(sender, Message.of(MessageKey.NPC_INVALID_ID).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
        String skin = args[2];
    ...
    private void handleClone(CommandSender sender, String[] args) {
        ...
        String newId = args[2];
        if (npcService.getNpcEntry(originalId) == null) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", originalId)); playSound(sender, SoundKeys.ERROR); return; }
        if (npcService.getNpcEntry(newId) != null) { Messages.send(sender, Message.of(MessageKey.NPC_INVALID_ID).with("id", newId)); playSound(sender, SoundKeys.ERROR); return; }
    ...
    private void handleRemove(CommandSender sender, String[] args) {
        ...
        String id = args[1];
        if (npcService.getNpcById(id) == null) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
    ...
    private void handleList(CommandSender sender) {
        ...
        if (ids.isEmpty()) { Messages.send(sender, MessageKey.NPC_LIST_EMPTY); playSound(sender, SoundKeys.NOTIFICATION); return; }
    ...
    private void handleInfo(CommandSender sender, String[] args) {
        ...
        if (entry == null) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
        ...
        Messages.send(sender, Message.of(MessageKey.COMMON_INFO_LINE).with("key", Messages.translate(MessageKey.NPC_INFO_SKIN)).with("value", entry.getItem()));
    ...
    private void handleAddLine(CommandSender sender, String[] args) {
        ...
        if (npcService.getNpcEntry(id) == null) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
    ...
    private void handleSetLine(CommandSender sender, String[] args) {
        ...
        if (!npcService.setLine(id, line, text)) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
    ...
    private void handleRemoveLine(CommandSender sender, String[] args) {
        ...
        String id = args[1]; int line;
        try { line = Integer.parseInt(args[2]); } catch (NumberFormatException e) { Messages.send(sender, MessageKey.DISPLAY_INVALID_LINE); playSound(sender, SoundKeys.ERROR); return; }
        if (!npcService.removeLine(id, line)) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
    ...
    private void handleRemoveAction(CommandSender sender, String[] args) {
        ...
        if (!npcService.removeAction(id, line)) { Messages.send(sender, Message.of(MessageKey.NPC_NOT_FOUND).with("id", id)); playSound(sender, SoundKeys.ERROR); return; }
    ...
    public List<String> tabComplete(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            switch(sub) {
                case "remover": case "clone": case "info": case "tphere": case "setskin":
                case "rename": case "togglename": case "togglelook": case "addline": case "setline":
                case "removeline": case "addaction": case "removeaction": case "listactions":
